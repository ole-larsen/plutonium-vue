 ...
 */
export declare const file_frontend_v1_collectible: GenFile;

/**
 * @generated from message frontend.v1.MarketplaceCollectible
 */
export declare type MarketplaceCollectible = Message<"frontend.v1.MarketplaceCollectible"> & {
  /**
 ...
 */
export declare type MarketplaceCollectibleAttributes = Message<"frontend.v1.MarketplaceCollectibleAttributes"> & {
  /**
 ...
 */
export declare type MarketplaceCollectibleDetails = Message<"frontend.v1.MarketplaceCollectibleDetails"> & {
  /**
 ...
 */
export declare type MarketplaceCollectibleMetadata = Message<"frontend.v1.MarketplaceCollectibleMetadata"> & {
  /**
 ...
 */
export declare type MetadataAttributes = Message<"frontend.v1.MetadataAttributes"> & {
  /**
