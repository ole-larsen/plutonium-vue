...
<!--              &lt;!&ndash;                <router-link to="/login" class="wishlist-button heart"><span class="number-like">100</span></router-link>&ndash;&gt;-->
<!--              &lt;!&ndash;                <div class="coming-soon">{{item.coomingsoon}}</div>&ndash;&gt;-->
<!--            </div>-->
...
<!--              &lt;!&ndash;                  <router-link to="/activity-01" class="view-history reload">History</router-link>&ndash;&gt;-->
<!--            </div>-->
<!--          </div>-->
<!--        </div>-->
