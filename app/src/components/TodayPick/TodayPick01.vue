...
// import { useTodayPickStore } from "@/stores/components/todayPick";
...
//
// const items: ComputedRef<PublicMarketItem[]> = computed(() => market.items.filter((_item: PublicMarketItem) => !_item.metadata.auction));
//
...
<!--              &lt;!&ndash;<router-link :to="todayPicks.btnLink" class="exp style2">{{ todayPicks.btnText }}</router-link>&ndash;&gt;-->
<!--            </div>-->
<!--          </div>-->
...
<!--                <router-link :to="_item['metadata']['url']" v-if="_item['metadata']"> <img :src="_item['metadata']['image']" :alt="_item['metadata']['name']"></router-link>-->
<!--                <span class="wishlist-button heart" @click="like(_item)">-->
<!--                  <span class="number-like">{{ likes ? likes[index] : 0 }}</span>-->
<!--                </span>-->
<!--&lt;!&ndash;                <div class="coming-soon">{{item.comingsoon}}</div>&ndash;&gt;-->
<!--              </div>-->
<!--              <div class="card-title">-->
<!--                <h5 class="style2"><router-link :to="_item['metadata']['url']">"{{_item['metadata']['name']}}"</router-link></h5>-->
<!--                <div class="tags">{{_item['metadata']['fulfilled'] ? 'sold' : _item['metadata']['tags']}}</div>-->
<!--              </div>-->

<!--              <div class="meta-info" v-if="_item && _item['owner'] && typeof _item['owner'] !== 'string'">-->
<!--                <div class="author">-->
<!--                  <div class="avatar">-->
...
<!--                  <h5> {{_item['metadata']['price']}}</h5>-->
<!--                </div>-->
<!--              </div>-->
<!--              <div class="card-bottom" :class="`${_item['comingsoon'] ? 'none' : ''}`" v-if="!_item['metadata']['fulfilled']">-->
