...
import DarkMode from "@/components/Header/DarkModeComponent.vue";
import HeaderMenu from "@/components/Header/HeaderMenuComponent.vue";
import HeaderProfile from "@/components/Header/HeaderProfileComponent.vue";
import HeaderSearch from "@/components/Header/HeaderSearchComponent.vue";
