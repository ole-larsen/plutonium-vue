...
<template>
  <section class="tf-section popular-collection">
              ...
              >
                <div class="sc-card-collection style-3">
                  <router-link :to="collection['attributes']['url']">
                    <div class="media-images-box">
                      <div class="top-media">
                        <img
                          :src="
                            collection['attributes']['collectibles'][0][
                              'attributes'
                            ]['metadata']['image']
                          "
                          :alt="
                        ...
                        <img
                          :src="
                            collection['attributes']['collectibles'][1][
                              'attributes'
                            ]['metadata']['image']
                          "
                          :alt="
                      ...
                      <div class="bottom-media">
                        <img
                          :src="
                            collection['attributes']['collectibles'][2][
                              'attributes'
                            ]['metadata']['image']
                          "
                          :alt="
                        ...
                        <img
                          :src="
                            collection['attributes']['collectibles'][3][
                              'attributes'
                            ]['metadata']['image']
                          "
                          :alt="
                        ...
                        <img
                          :src="
                            collection['attributes']['collectibles'][4][
                              'attributes'
                            ]['metadata']['image']
                          "
                          :alt="
                  ...
                  <div class="card-bottom">
                    <div class="author" v-if="collection['attributes']['creator']">
                    ...
                    <router-link
                      to="/login"
                      class="wishlist-button public heart"
