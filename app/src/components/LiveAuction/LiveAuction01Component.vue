...
import Collectible01 from "@/components/LiveAuction/Collectible01Component.vue";
import Single01 from "@/components/LiveAuction/Single01Component.vue";
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="heading-live-auctions">
            ...
            <router-link to="/live-auctions" class="exp style2"
        ...
        <div class="col-md-12">
          ...
          >
            <Slide v-for="collectible in collectibles" :key="collectible.id">
