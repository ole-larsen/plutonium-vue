  ...
  <div class="sc-card-product">
    <div class="card-media">
      ...
      <div class="featured-countdown" v-if="endTimestamp > nowTimestamp">
        ...
        <Countdown
          starttime="Mar 24, 2023 15:37:25"
          :endtime="endDatetime.format('MMMM DD, YYYY, hh:mm:ss')" >
        </Countdown>
      </div>
      <div class="button-place-bid" v-if="endTimestamp > nowTimestamp">
        <button class="sc-button style-place-bid style bag fl-button pri-3"  v-on:click="toggleActive"><span>Place Bid</span></button>
      </div>
    </div>
