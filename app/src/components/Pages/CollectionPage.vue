...
import Filter from "@/components/Collection/FilterComponent.vue";
      ...
      <div class="themesflat-container">
        <div class="infor-collection">
          ...
          <div class="content">
            <div class="content-item">
              Items: {{ collection["attributes"]["collectibles"].length }}
            </div>
            <div class="content-item">·</div>
            <div class="content-item">
              Created <strong>{{ collection["attributes"]["created"] }}</strong>
            </div>
            <div class="content-item">·</div>
            <div class="content-item">
              Market Fee
              <strong
                >{{
                  ethers.utils.formatEther(collection["attributes"]["fee"])
                }}
                %</strong
              >
            </div>
            ...
            <div
              class="content-item"
              v-if="collection['attributes']['category']"
            >
              Category
              <strong>
          ...
          <div
            class="description"
            v-html="collection['attributes']['description']"
          ></div>
          <div class="content">
            <div class="content-item">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 col-12" v-if="collection">
            <Filter :collectibles="collection['attributes']['collectibles']" />
          </div>
