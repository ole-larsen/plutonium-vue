...
import ERC721Modal from "@/components/Profile/ERC721Modal.vue";

import Personal from "@/components/Profile/Personal.vue";
import Wallpaper from "@/components/Profile/Wallpaper.vue";
...
<template>
  <div class="tf-profile">
    <section class="tf-section tf-activity s1 authors profile" v-if="collection">
      ...
      <collection-modal :user="user" :collection="collection" @reloadCollection="reloadCollection"/>
      <ERC721Modal :user="user" :collections="collections" :collectible="collectible"/>
    </section>
  </div>
</template>