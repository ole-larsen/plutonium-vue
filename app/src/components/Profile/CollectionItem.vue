  ...
  <div class="sc-card-product explode ">
    <div class="card-media">
      ...
      <div class="button-place-bid">
        <button class="sc-button style-place-bid style bag fl-button pri-3" v-on:click="editCollection(collection)"><span>Edit</span></button>
      </div>
    </div>
    ...
    <div class="meta-info" v-if="collection['attributes']['owner']">
      <div class="author">
        <div class="avatar">
          <img :src="collection['attributes']['owner']['gravatar']" :alt="collection['attributes']['owner']['username']">
        </div>
        <div class="info">
          <span>Owner</span>
          <h6>
            <router-link :to="`/author/${collection['attributes']['owner']['username']}`">
              {{collection['attributes']['owner']['username'].length > 10 ? collection['attributes']['owner']['username'].slice(0, 4) + "..." + collection['attributes']['owner']['username'].slice(-4) : collection['attributes']['owner']['username']}}
            </router-link>
          </h6>
        </div>
      </div>
