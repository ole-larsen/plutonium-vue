...
if (collection?.value) {
  watch(
    ...
    (name: string) => {
      ...
      (collection.value as CollectionDTO).url =
        "/" + "collection" + "/" + (collection.value as CollectionDTO).slug;
    }
  );
}
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <button
          ...
          data-dismiss="modal"
          aria-label="Close"
          @click="handleCloseCollectionModal"
        >
          <span aria-hidden="true">&times;</span>
        </button>
        <div
          class="modal-body space-y-20 pd-40 collection-form"
          :class="{ show: isActiveCollectionModal }"
        >
          ...
          <div v-show="!loading">
            ...
            <div class="row-form style-2">
              ...
              <div
                v-if="collection.featured.attributes"
              ...
              <input
                ...
                type="file"
                ref="featured"
                v-on:change="handleFeaturedUpload()"
              />
            </div>
            <div class="row-form style-2">
            ...
            <div class="row-form style-2">
              ...
              >
                ...
                <option
                  v-for="_category in collection.categories"
                  :value="_category.id"
